...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `introduzirAlertaErro` AFTER INSERT ON `erroexperiencia` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `validarDadosExperiencia` BEFORE INSERT ON `experiencia` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `validarDadosPassagem` BEFORE INSERT ON `medicaopassagem` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `validarDadosMedicaoTemperatura` BEFORE INSERT ON `medicaotemperatura` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `validarDadosOdor` BEFORE INSERT ON `odor` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `validarDadosSubstancia` BEFORE INSERT ON `substancia` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `validarDadosSubsExpr` BEFORE INSERT ON `substanciaexperiencia` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `dadosValidosTipoAlertaInsert` BEFORE INSERT ON `tipoalerta` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `dadosValidosTipoAlertaUpdate` BEFORE UPDATE ON `tipoalerta` FOR EACH ROW BEGIN
...
/*!50001 VIEW `alertas` AS select `a`.`Id` AS `Id`,`a`.`IdExperiencia` AS `IdExperiencia`,`a`.`DataHora` AS `DataHora`,`ta`.`Descricao` AS `title`,`ta`.`Valor` AS `Valor`,`a`.`Descricao` AS `Descricao` from (`alerta` `a` join `tipoalerta` `ta` on(`ta`.`Id` = `a`.`IdTipoAlerta`)) */;
