...
INSERT INTO `parametrosadicionais` VALUES ('NUM_MAX_ALERTA','1','3','Número máximo de alertas (3) para o Tipo de Alerta (1)'),('NUM_MAX_ALERTA','2','2','Número máximo de alertas (2) para o Tipo de Alerta (2)'),('NUM_MAX_ALERTA','3','1','Número máximo de alertas (1) para o Tipo de Alerta (3)'),('NUM_MAX_ALERTA','4','1','Número máximo de alertas (1) para o Tipo de Alerta (4)'),('NUM_MAX_ALERTA','5','1','Número máximo de alertas (1) para o Tipo de Alerta (5)'),('NUM_MAX_ALERTA','TEMPO','120','Numero máximo de alerta no intervalo de VALOR expresso em segundos'),('TEMPO_CHECK_FINS','TEMPO','15','Tempo entre verificações de final de experiências em segundos'),('TEMPO_ENTRE_CHECK_MOVIMENTO','TEMPO','5','Verificar se o tempo sem movimento dos ratos da ultima experiencia a ocorrer de [valor] em [valor] segundos.'),('TEMPO_ENTRE_EXPERIENCIA','TEMPO','10','Tempo minimo entre experiencias em minutos.');
...
INSERT INTO `tipoalerta` VALUES (1,'Alerta Vermelho',NULL),(2,'Alerta Amarelo',NULL),(3,'Alerta Verde',NULL),(4,'Limite Ratos',NULL),(5,'Segundos Sem Movimento',NULL);
