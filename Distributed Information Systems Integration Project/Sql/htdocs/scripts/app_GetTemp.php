...
if(!empty($_POST['idExperience'])) $idExperience = $_POST['idExperience'];
        ...
        function getTemp($idExperience, $conn){
            $util= Utils::getInstance();
            $array = array();
            $sql="SELECT DataHora, Leitura, Sensor FROM medicaotemperatura WHERE IdExperiencia = ".$idExperience;
            //. $idExperience
